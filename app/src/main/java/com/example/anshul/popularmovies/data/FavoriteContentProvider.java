...
import static com.example.anshul.popularmovies.data.FavoritesContract.FavoritesEntry.TABLE_NAME;
...
public class FavoriteContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         */
        uriMatcher.addURI(FavoritesContract.AUTHORITY, FavoritesContract.PATH_FAVS, TASKS);
        uriMatcher.addURI(FavoritesContract.AUTHORITY, FavoritesContract.PATH_FAVS + "/#", TASK_WITH_ID);
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        Log.v("Checkin cont", "Contract Insert");
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case TASK_WITH_ID:
                ...
                String movieTitle = uri.getPathSegments().get(1);
                // Use selections/selectionArgs to filter for this ID
                tasksDeleted = db.delete(TABLE_NAME, FavoritesContract.FavoritesEntry.COLUMN_MOVIE_TITLE+"=?",
